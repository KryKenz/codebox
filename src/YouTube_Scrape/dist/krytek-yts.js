      ...
      1: [
        function (require, module, exports) {
          ...
          var DEFAULT_USER_AGENT =
            "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html) (krytek-yts; https://www.npmjs.com/package/krytek-yts)";
          ...
          module.exports._parseSearchResultInitialData =
          ...
          module.exports._parsePlaylistLastUpdateTime =
            _parsePlaylistLastUpdateTime;
          /**
           * Main
           */
          ...
          function search(query, callback) {
            ...
            if (!_options.search) {
              return callback(Error("krytek-yts: no query given"));
            }
          ...
          function getSearchResults(_options, callback) {
            ...
            var pageEnd =
              Number(_options.pageEnd) || Number(_options.pages) || 1; // handle zero-index start
                ...
                try {
                  _parseSearchResultInitialData(body, function (err, results) {
                    ...
                    if (getMoreResults && results._sp) {
                      ...
                      var _playlists =
                        _options._data.playlists.filter(_playlistFilter);

                      var _channels =
                        _options._data.channels.filter(_channelFilter);
          ...
          function _parseSearchResultInitialData(responseText, callback) {
            ...
            if (!initialData) {
              return callback(
                "could not find inital data in the html document"
              );
            }
            ...
            _jp
              .query(json, "$..primaryContents..contents.*")
            ...
            for (var _i = 0; _i < items.length; _i++) {
              ...
              var watchingLabel = _jp
                .query(item, "$..viewCountText..text")
                .join("");

              var isUpcoming = // if scheduled livestream (has not started yet)
                _jp
                  .query(item, "$..thumbnailOverlayTimeStatusRenderer..style")
                  .join("")
                  .toUpperCase()
                  .trim() === "UPCOMING";
              var isLive =
                ...
                _jp
                  .query(item, "$..badges..label")
                  .join("")
                  .toUpperCase()
                  .trim() === "LIVE NOW" ||
                _jp
                  .query(item, "$..thumbnailOverlayTimeStatusRenderer..text")
                  .join("")
                  .toUpperCase()
                  .trim() === "LIVE" ||
                isUpcoming;
                  ...
                  case "video":
                    {
                      var thumbnail =
                        _normalizeThumbnail(
                          _jp.value(item, "$..thumbnail..url")
                        ) ||
                        _normalizeThumbnail(
                          _jp.value(item, "$..thumbnails..url")
                        ) ||
                      ...
                      var author_url =
                        ...
                        _jp.value(item, "$..longBylineText..url"); // publish/upload date
                      ...
                      var description =
                        ...
                        _jp.query(item, "$..descriptionSnippet..text").join(""); // url ( playlist )
                  ...
                  case "list":
                    {
                      ...
                      var video_count =
                        ...
                        _jp.value(item, "$..thumbnailText..simpleText"); // url ( playlist )
                      // const url = _jp.value( item, '$..navigationEndpoint..url' )
                  ...
                  case "channel":
                    {
                      ...
                      var sub_count_label =
                        ...
                        _jp.value(item, "$..subscriberCountText..simpleText"); // first space separated word that has digits
                  ...
                  case "live":
                    {
                      ...
                      var _watchingLabel =
                        ...
                        _jp
                          .query(item, "$..viewCountText..simpleText")
                          .join("") ||
                        "0";

                      var watchCount = Number(
                        _watchingLabel
                          .split(/\s+/)[0]
                          .split(/[,.]/)
                          .join("")
                      ...
                      var scheduledEpochTime = _jp.value(
                        item,
                        "$..upcomingEventData..startTime"
                      );

                      var scheduledTime =
                        Date.now() > scheduledEpochTime
                          ? scheduledEpochTime * 1000
                          : scheduledEpochTime;

                      var scheduledDateString =
                        _toInternalDateString(scheduledTime); // url ( playlist )
                      // const url = _jp.value( item, '$..navigationEndpoint..url' )
          ...
          function getVideoMetaData(opts, callback) {
            ...
            var uri = "https://www.youtube.com/watch?hl="
              .concat(hl, "&gl=")
              .concat(gl, "&v=")
              .concat(videoId);
          ...
          function _parseVideoInitialData(responseText, callback) {
            ...
            var initialPlayerData = _between(
            ...
            if (!initialPlayerData) {
              return callback(
                "could not find inital player data in the html document"
              );
            } // debug( initialData[ 0 ] )
            // debug( '\n------------------\n' )
            ...
            var description =
              ...
              _jp
                .query(ipdata, "$..microformat..description..simpleText")
                .join("") ||
            ...
            var agoText =
              (uploadDate && _humanTime(new Date(uploadDate))) || "";
            var video = {
              title: title,
              description: description,
          ...
          function getPlaylistMetaData(opts, callback) {
            ...
            var uri = "https://www.youtube.com/playlist?hl="
              .concat(hl, "&gl=")
              .concat(gl, "&list=")
              .concat(listId);
          ...
          function _parsePlaylistInitialData(responseText, callback) {
            ...
            responseText = _getScripts(responseText);
            var jsonString = responseText.match(
              /ytInitialData.*=\s*({.*});/
            ...
            if (
              plerr &&
              typeof plerr.type === "string" &&
              plerr.type.toLowerCase() === "error"
            ) {
            ...
            var listId = _jp
              .value(json, "$..microformat..urlCanonical")
              .split("=")[1]; // console.log( 'listId: ' + listId )

            var viewCount = 0;

            try {
              var viewCountLabel = _jp.value(
                json,
                "$..sidebar.playlistSidebarRenderer.items[0]..stats[1].simpleText"
              );
            ...
            var size = (
              _jp.value(
                json,
                "$..sidebar.playlistSidebarRenderer.items[0]..stats[0].simpleText"
              ) ||
              _jp
                .query(
                  json,
                  "$..sidebar.playlistSidebarRenderer.items[0]..stats[0]..text"
                )
                .join("")
            )
              .match(/\d+/g)
              .join(""); // playlistVideoListRenderer contents
            ...
            var listHasContinuation =
              _typeof(list[list.length - 1].continuationItemRenderer) ===
              "object"; // const list = _jp.query( json, '$..contents..tabs[0]..contents[0]..contents[0]..contents' )[ 0 ]
            ...
            list.forEach(function (item) {
              ...
              var duration = _parseDuration(
                _jp.value(json, "$..lengthText..simpleText") ||
                  ...
                  _jp
                    .query(json, "$..thumbnailOverlayTimeStatusRenderer..text")
                    .join("")
              );
              ...
              var video = {
                ...
                // ref: issue #35 https://github.com/talmobi/krytek-yts/issues/35
                duration: duration,
                author: {
                  name: _jp.value(json, "$..shortBylineText..runs[0]..text"),
                  url:
                    "https://youtube.com" +
                    _jp.value(json, "$..shortBylineText..runs[0]..url"),
                },
              };
              videos.push(video);
            }); // console.log( videos )
            ...
            var plthumbnail =
              _normalizeThumbnail(
                _jp.value(json, "$..microformat..thumbnail..url")
              ) ||
              _normalizeThumbnail(
                _jp.value(json, "$..microformat..thumbnails..url")
              ) ||
              _normalizeThumbnail(
                _jp.value(json, "$..microformat..thumbnails")
              );
            ...
            var playlist = {
              ...
              date: _parsePlaylistLastUpdateTime(
                _jp.value(
                  json,
                  "$..sidebar.playlistSidebarRenderer.items[0]..stats[2]..simpleText"
                ) ||
                  _jp
                    .query(
                      json,
                      "$..sidebar.playlistSidebarRenderer.items[0]..stats[2]..text"
                    )
                    .join("") ||
                  ""
              ),
              ...
              author: {
                ...
                url:
                  "https://youtube.com" +
                  _jp.value(json, "$..videoOwner..navigationEndpoint..url"),
              },
            };
          ...
          function _parseVideoMeataDataTitle(idata) {
            var t =
              _jp
                .query(idata, "$..videoPrimaryInfoRenderer.title..text")
                .join("") ||
              _jp
                .query(idata, "$..videoPrimaryInfoRenderer.title..simpleText")
                .join("") ||
              _jp
                .query(idata, "$..videoPrimaryRenderer.title..text")
                .join("") ||
              _jp
                .query(idata, "$..videoPrimaryRenderer.title..simpleText")
                .join("") ||
              _jp.value(idata, "$..title..text") ||
              _jp.value(idata, "$..title..simpleText"); // remove zero-width chars
          ...
          function test(query) {
            ...
            search(opts, function (error, r) {
              ...
              playlists.forEach(function (p) {
                console.log(
                  "playlist: ".concat(p.title, " | ").concat(p.listId)
                );
              });
              channels.forEach(function (c) {
                console.log(
                  "channel: ".concat(c.title, " | ").concat(c.description)
                );
              });
            });
          }
