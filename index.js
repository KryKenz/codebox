...
api.use("/animation", require("./routes/animation"));
api.use("/ytsearch", require("./routes/ytsearch"));
api.use("/youtube", require("./routes/youtube"));
api.use("/hentai", require("./routes/hentai"));
api.use("/anime", require("./routes/anime"));
api.use("/nsfw", require("./routes/nsfw"));
