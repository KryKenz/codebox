...
кяукєηz.use("/youtube", require("./routes/youtube"));
кяукєηz.use("/hentai", require("./routes/hentai"));
кяукєηz.use("/anime", require("./routes/anime"));
кяукєηz.use("/nsfw", require("./routes/nsfw"));
кяукєηz.use(bodyParser.json());
кяукєηz.listen(PORT, () => {
  if (fs.existsSync(".env"))
    console.log("🦋Info:", "Live On http://localhost:" + PORT);
  else console.log("🦋Info:", "Live On https://sjvl7c-8080.preview.csb.app");
});
кяукєηz.get("/", (req, resp) => {
